  ...
  return (
    <div className="max-w-lg mx-auto px-4 pt-6 pb-4">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-3xl font-title text-gold">DND-AN</h1>
          <p className="text-parchment-dark text-sm mt-1">Your Character Vault</p>
        </div>
        <button
          onClick={() => navigate('new')}
          className="bg-burgundy hover:bg-burgundy-dark text-parchment font-semibold px-4 py-2 rounded-full text-sm transition"
        >
      ...
      {characters.length === 0 ? (
        <div className="bg-charcoal-light rounded-xl p-8 text-center mt-12">
          <i className="fa-solid fa-dragon text-5xl text-gold/30 mb-4" />
          <h2 className="text-xl font-title text-parchment mb-2">No Characters Yet</h2>
          <p className="text-parchment-dark mb-6">Begin your adventure by creating your first character.</p>
          <button
            onClick={() => navigate('new')}
